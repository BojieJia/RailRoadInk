...
public class task8Test {
    ...
    @Test
    public void getCorrectBasicScore() {
        int score = RailroadInk.getBasicScore(simple);
        int simpleCorrectScore = -8;
        assertTrue("Failure", simpleCorrectScore == score);
    }

    @Test

    public void getScorefirst() {
        for (int i = 0; i < boardString.length; i++) {
            int score = RailroadInk.getBasicScore(boardString[i]);
            assertTrue("Failure", correctScore[i] == score);
        }
    }


    static final String simple = "A4A16B2B14S2C13S5D12S3D25";


    static final String[] boardString = {
    ...
    static final int[] correctScore = {
            33, 24, 18, 21, 15, 23, 23
    };
