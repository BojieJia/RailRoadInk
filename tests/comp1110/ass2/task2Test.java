...
public class task2Test {
    ...
    @Test
    public void wellFormedone() {
        for (String test : wellFormedone) {
    ...
    public void wellFormedtwo() {
        for (String test : wellFormedtwo) {
    ...
    @Test
    public void wellFormedthree() {
        for (String test : wellFormedthree) {
            assertFalse("Placement sequence '" + test + "' is valid, but failed ", RailroadInk.isTilePlacementWellFormed(test));
        }
    }


    static final String[] wellFormedone = {
            "A1F10A2F16A3F17A4F22S1G27",
            "A3B10S3B10B2B12"
    };
    static final String[] wellFormedtwo = {
    ...
    static final String[] wellFormedthree = {
