...
public class MultiPlayer extends Application {
    ...
    private void makeControls() {
        ...
        rollDice.setLayoutX(4 * DIMENSIONS - 6);
        rollDice.setLayoutY(8 * DIMENSIONS + DIMENSIONS/2);
        ...
        setDimensions1.setLayoutX(TILE_LOCATIONS[0][1] + DIMENSIONS + 10);
        setDimensions1.setLayoutY(TILE_LOCATIONS[0][0]);
        ...
        setDimensions2.setLayoutX(TILE_LOCATIONS[1][1] + DIMENSIONS + 10);
        setDimensions2.setLayoutY(TILE_LOCATIONS[1][0]);
        ...
        setDimensions3.setLayoutX(TILE_LOCATIONS[2][1] + DIMENSIONS + 10);
        setDimensions3.setLayoutY(TILE_LOCATIONS[2][0]);
        ...
        setDimensions4.setLayoutX(TILE_LOCATIONS[3][1] + DIMENSIONS + 10);
        setDimensions4.setLayoutY(TILE_LOCATIONS[3][0]);
        ...
        flip1.setLayoutX(TILE_LOCATIONS[0][1] + DIMENSIONS + 10);
        flip1.setLayoutY(TILE_LOCATIONS[0][0] + DIMENSIONS/3);
        ...
        flip2.setLayoutX(TILE_LOCATIONS[1][1] + DIMENSIONS + 10);
        flip2.setLayoutY(TILE_LOCATIONS[1][0] +  DIMENSIONS/3);
        ...
        flip3.setLayoutX(TILE_LOCATIONS[2][1] + DIMENSIONS + 10);
        flip3.setLayoutY(TILE_LOCATIONS[2][0] + DIMENSIONS/3);
        ...
        flip4.setLayoutX(TILE_LOCATIONS[3][1] + DIMENSIONS + 10);
        flip4.setLayoutY(TILE_LOCATIONS[3][0] + DIMENSIONS/3);
    ...
    private void drawBoard() {
        ...
        for(int p = 0; p < 4; p++) {
            Line line1 = new Line();
            line1.setStartX(TILE_LOCATIONS[p][1]);
            line1.setStartY(TILE_LOCATIONS[p][0]);
            line1.setEndX(TILE_LOCATIONS[p][1] + DIMENSIONS);
            line1.setEndY(TILE_LOCATIONS[p][0]);
            root.getChildren().add(line1);

            Line line2 = new Line();
            line2.setStartX(TILE_LOCATIONS[p][1]);
            line2.setStartY(TILE_LOCATIONS[p][0] + DIMENSIONS);
            line2.setEndX(TILE_LOCATIONS[p][1] + DIMENSIONS);
            line2.setEndY(TILE_LOCATIONS[p][0] + DIMENSIONS);

            root.getChildren().add(line2);

            Line line3 = new Line();
            line3.setStartX(TILE_LOCATIONS[p][1]);
            line3.setStartY(TILE_LOCATIONS[p][0]);
            line3.setEndX(TILE_LOCATIONS[p][1]);
            line3.setEndY(TILE_LOCATIONS[p][0] + DIMENSIONS);

            root.getChildren().add(line3);

            Line line4 = new Line();
            line4.setStartX(TILE_LOCATIONS[p][1] + DIMENSIONS);
            line4.setStartY(TILE_LOCATIONS[p][0]);
            line4.setEndX(TILE_LOCATIONS[p][1] + DIMENSIONS);
            line4.setEndY(TILE_LOCATIONS[p][0] + DIMENSIONS);
